...
public class MemPictureAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		dao.updatepic(email,fname);
		request.getSession().setAttribute("picture", fname);
		...
		return new ActionForward(true,"mypage.do?email="+email);
	}
